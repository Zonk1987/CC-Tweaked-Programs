...
function PortalUI.drawOverlayFrame(bm, x1, y1, x2, y2)
...
function PortalUI.drawColorSwatchFrame(bm, x1, y1, x2, y2)
...
function PortalUI.drawSmallButtonFrame(bm, x1, y1, x2, y2)
