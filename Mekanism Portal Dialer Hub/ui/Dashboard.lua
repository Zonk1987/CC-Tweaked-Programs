...
function Dashboard.drawOverlayFrame(bm, x1, y1, x2, y2)
	...
	for i = x1 + 1, x2 - 1 do
		bm.mon.setTextColor(frameFG)
		bm.mon.setBackgroundColor(frameBG)
		bm.mon.setCursorPos(i, y1)
		bm.mon.write(string.char(char_HO))
		bm.mon.setTextColor(frameBG)
		bm.mon.setBackgroundColor(frameFG)
		bm.mon.setCursorPos(i, y2)
		bm.mon.write(string.char(char_HU))
	end
	...
	for i = y1 + 1, y2 - 1 do
		bm.mon.setTextColor(frameFG)
		bm.mon.setBackgroundColor(frameBG)
		bm.mon.setCursorPos(x1, i)
		bm.mon.write(string.char(char_V))
		bm.mon.setTextColor(frameBG)
		bm.mon.setBackgroundColor(frameFG)
		bm.mon.setCursorPos(x2, i)
		bm.mon.write(string.char(char_V))
	end
end
...
function Dashboard.drawColorSwatchFrame(bm, x1, y1, x2, y2, color)
	...
	bm.mon.setCursorPos(x1 - 1, y1 - 1)
	bm.mon.write(string.char(char_TL))
	bm.mon.setTextColor(frameFG)
	bm.mon.setBackgroundColor(frameBG)
	bm.mon.setCursorPos(x2 + 1, y1 - 1)
	bm.mon.write(string.char(char_TR))
	bm.mon.setCursorPos(x1 - 1, y2 + 1)
	bm.mon.write(string.char(char_BL))
	bm.mon.setCursorPos(x2 + 1, y2 + 1)
	bm.mon.write(string.char(char_BR))

	for i = x1, x2 do
		bm.mon.setTextColor(frameBG)
		bm.mon.setBackgroundColor(frameFG)
		bm.mon.setCursorPos(i, y1 - 1)
		bm.mon.write(string.char(char_HO))
		bm.mon.setTextColor(frameFG)
		bm.mon.setBackgroundColor(frameBG)
		bm.mon.setCursorPos(i, y2 + 1)
		bm.mon.write(string.char(char_HU))
	end
	...
	for i = y1, y2 do
		bm.mon.setTextColor(frameBG)
		bm.mon.setBackgroundColor(frameFG)
		bm.mon.setCursorPos(x1 - 1, i)
		bm.mon.write(string.char(char_V))
		bm.mon.setTextColor(frameFG)
		bm.mon.setBackgroundColor(frameBG)
		bm.mon.setCursorPos(x2 + 1, i)
		bm.mon.write(string.char(char_V))
	end
end
...
function Dashboard.drawSmallButtonFrame(bm, x1, y1, x2, y2)
	...
	for i = x1 + 1, x2 - 1 do
		bm.mon.setCursorPos(i, y1)
		bm.mon.write(string.char(char_H))
		bm.mon.setCursorPos(i, y2)
		bm.mon.write(string.char(char_H))
	end
end
