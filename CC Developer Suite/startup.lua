--[[
================================================================================
CC:Tweaked Developer Suite v1.0.078-main
================================================================================
...
function DevToolkit.mainMenu()
	while true do
		header("Developer Suite v1.0.078-main")
		...
		if key == keys.one then
			DevToolkit.peripheralInspector()
		elseif key == keys.two then
			DevToolkit.eventSniffer()
		elseif key == keys.three then
			DevToolkit.redstoneMonitor()
		elseif key == keys.four then
			DevToolkit.fileExplorer()
		elseif key == keys.five then
			DevToolkit.networkScanner()
		elseif key == keys.six then
			DevToolkit.toggleRednet()
