...
function ButtonGrid:drawButtonBox(x1, y1, x2, y2, color)
	...
	self.mon.setBackgroundColor(colors.black)
	self.mon.setCursorPos(x1, y2)
	self.mon.write(string.char(141)) -- BL
	self.mon.setCursorPos(x2, y2)
	self.mon.write(string.char(142)) -- BR (Bridge Mirror)
end
...
function ButtonGrid:drawFineBox(x1, y1, x2, y2, color)
	...
	self.mon.write(string.char(156)) -- TL
	self.mon.setCursorPos(x2, y1)
	self.mon.write(string.char(148)) -- TR
	self.mon.setCursorPos(x1, y2)
	self.mon.write(string.char(141)) -- BL
	self.mon.setCursorPos(x2, y2)
	self.mon.write(string.char(133)) -- BR
end
