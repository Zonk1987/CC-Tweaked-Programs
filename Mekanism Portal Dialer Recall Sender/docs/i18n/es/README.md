...
- **Estado del portal en vivo (opcional)**: monitoreo en tiempo real del estado del portal local (por ejemplo, "Listo", "Sin energía") si un bloque de Teletransportador local está conectado físicamente (de lo contrario, el valor predeterminado es "Solo concentrador remoto").
...
3. **Disparador de Redstone**: conecte un botón, una placa de presión o cualquier fuente de Redstone a cualquier lado de la computadora.
